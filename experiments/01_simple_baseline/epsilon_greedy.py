...
for i in range(1000):
    ...
    ss=bandit.pull(sss)
    RAA.update(sss,ss)
os.makedirs("results/01_simple_baseline", exist_ok=True)
plt.plot(regret)
plt.xlabel("Round")
plt.ylabel("cumulative regret")
plt.title("Random Agent Regret Curve--epsilon greedy")
plt.savefig("results/01_simple_baseline/epsilon_greedy.png", dpi=200, bbox_inches="tight")
